...
urlpatterns = [
    ...
    path("request/<int:pk>/bawad-proof/view/", views.view_bawad_proof, name="view_bawad_proof"),
    path("request/<int:pk>/client-signature/view/", views.view_client_signature, name="view_client_signature"),
    path("request/<int:pk>/print/", views.print_application, name="print_application"),
    path("request/<int:pk>/cancel/", views.consumer_cancel_request, name="consumer_cancel_request"),
